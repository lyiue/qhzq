...
function getPDFFileNameFromURL(url) {
  var defaultFilename = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '检测报告.pdf';
...
var DEFAULT_URL = 'http://'+ip+'/api/GetLib/getFile?RoadID='+localStorage.getItem("selectId")+'&Type=MaintenanceAssessment';
;
